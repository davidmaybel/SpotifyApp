...
const categoriesIDFilePath = path.join(__dirname, 'categoriesId.json');
const categoriesPlaylistsFilePath = path.join(__dirname, 'categoriesPlaylists.json');
const newReleasesFilePath = path.join(__dirname, 'newReleases.json');
const MeFilePath = path.join(__dirname, 'me.json');
const MeFollowingFilePath = path.join(__dirname, 'meFollowing.json');
const MeTracksFilePath = path.join(__dirname, 'meTracks.json');
